...
export const MODULES = [
  // ═══════════════ TIER 1 — FOUNDATIONS ════════════════
  {
    ...
    kolbScenario: {
      ...
      concreteSituation: "You've just moved into a flat. Your weekly income is $480 (StudyLink $333 + part-time $147). Your rent is $220/week. You also have to pay a 2-week bond upfront.",
      predictionPrompt: "How much money do you think you'll have left each week after paying rent?",
      predictionUnit: "$/week",
      actualOutcome: 265,
      actualExplanation: "After $220 rent, you have $260/week — but this is BEFORE groceries, power, internet, and transport. The number feels large until you subtract those.",
      bondAmount: 440,
      conceptCard: {
      ...
      applyQuestion: {
        prompt: "Your income drops to $400/week next month (fewer shifts). Your rent stays at $220. Which item should you cut first?",
        options: [
          { text: "Streaming subscriptions ($18/week)", correct: true, explanation: "Correct — discretionary spending is always cut before fixed costs. Subscriptions are wants, not needs." },
    ...
    quiz: [
      ...
      },
      {
        bloom: "Apply",
        bloomColor: "#FEF9C3",
        question: "You earn $450/week. Fixed costs total $330. How much is available for discretionary spending?",
        options: ["$450", "$330", "$120", "$140"],
        correct: 2,
        correctExplanation: "$450 − $330 = $120. This is your discretionary surplus — the amount you can choose how to spend.",
        wrongExplanation: "Subtract fixed costs from income: $450 − $330 = $120. That's the discretionary surplus.",
        retryExplanation: "Take your total income ($450) and subtract everything you MUST pay ($330). What's left?",
      },
      {
        bloom: "Evaluate",
        bloomColor: "#FCE7F3",
...

  {
    ...
    kolbScenario: {
      ...
      predictionUnit: "$/week",
      actualOutcome: 80,
      actualExplanation: "A well-planned student grocery shop typically costs $70–90/week for basics. Extras (wine, gadgets, premium brands) can push this to $120+ quickly.",
      conceptCard: {
      ...
      applyQuestion: {
        prompt: "You're short $35 this week. Your grocery basket has: bread & eggs ($14), a bottle of wine ($20), branded cereal ($7), and an energy drink ($4). What's the best cut?",
        options: [
          { text: "Remove wine + energy drink (save $24), swap to home-brand cereal (save $3)", correct: true, explanation: "Excellent — you kept the need (food), cut the clear wants (alcohol, energy drink), and found a cheaper alternative for a borderline item." },
          ...
          { text: "Remove only the cereal", correct: false, explanation: "You'd only save $7, not enough. The wine ($20) and energy drink ($4) are wants that can be cut more painlessly." },
        ],
      },
    },
    quiz: [
      ...
      },
      {
        bloom: "Apply",
        bloomColor: "#FEF9C3",
        question: "You have $60 left for the week. You need: bus pass ($22), dinner ingredients ($20), and want: a new game ($40). What should you buy?",
        options: [
          "Just the game — it's only $40",
          "Bus pass + dinner ingredients ($42 total) — cover needs first",
          "The game + bus pass — skip dinner",
          "Nothing — save all of it"
        ],
        correct: 1,
        correctExplanation: "Needs first: bus pass (transport to uni/work) and food are non-negotiable. With $60, buying both needs leaves $18 left — the game can wait.",
  ...
  // ═══════════════ TIER 2 — FLAT LIFE ════════════════
  {
    ...
    kolbScenario: {
      ...
      concreteSituation: "It's July. Your flat of 3 people just received a power bill for $350 — much higher than the $100 you expected. One flatmate runs a heater 24/7. You're splitting bills equally.",
      predictionPrompt: "How much do you predict your equal share of the bill will be?",
      predictionUnit: "$",
      actualOutcome: 117,
      actualExplanation: "$350 ÷ 3 = $117 each — over triple what you expected. This is Seasonal Cost Variation: winter heating dramatically increases power bills.",
      conceptCard: {
      ...
      applyQuestion: {
        prompt: "To prevent this next month, you suggest each flatmate pays $50/week into a shared 'bills fund'. How much will be in the fund after 4 weeks (3 people)?",
        options: [
          { text: "$150", correct: false, explanation: "That's just one person's contribution. Multiply by all 3 flatmates." },
          { text: "$600", correct: true, explanation: "Correct: $50 × 3 flatmates × 4 weeks = $600. A pooled bills fund prevents bill-shock surprises." },
          { text: "$200", correct: false, explanation: "That's $50 × 4 weeks for one person. You need to multiply by 3 flatmates as well." },
        ],
      },
    },
    quiz: [
      ...
      },
      {
        bloom: "Apply",
        bloomColor: "#FEF9C3",
        question: "Monthly rent is $2,100. Room A is worth $850/month elsewhere; rooms B and C are each worth $625. What's the proportional split?",
        options: [
          "$700 / $700 / $700",
          "$850 / $625 / $625",
          "$900 / $650 / $550",
        ...
        correct: 3,
        correctExplanation: "Proportional: Room A = $850/($850+$625+$625) × $2100 = $850. B and C = $625/$2100 × $2100 = $625 each. Proportional is fairer when room quality differs.",
        wrongExplanation: "Proportional split: divide each room's market value by the total market value ($2,100), then multiply by actual rent.",
        retryExplanation: "Add up the individual market values ($850+$625+$625=$2,100), then find each room's percentage of that total and apply it to actual rent.",
      },
      {
        bloom: "Evaluate",
        bloomColor: "#FCE7F3",
...

  {
    ...
    kolbScenario: {
      ...
      concreteSituation: "It's Week 6. Your car needs a WoF — it fails. The mechanic quotes $480 for repairs. You have $200 in your account and $150 in a savings jar. You need the car for your part-time job.",
      predictionPrompt: "How much do you predict a typical unexpected car repair costs a student?",
      predictionUnit: "$",
      actualOutcome: 480,
      actualExplanation: "$480 is a moderate repair — WoF fails often cost $250–800. Without an emergency buffer, you'd need to borrow money or miss work shifts, compounding the problem.",
      conceptCard: {
      ...
      applyQuestion: {
        prompt: "Your estimated monthly costs are $1,800. With a 12% buffer, how much should you set aside?",
        options: [
          { text: "$1,812", correct: false, explanation: "12% of $1,800 is $216, not $12. The buffer should be $1,800 × 1.12 = $2,016." },
          { text: "$2,016", correct: true, explanation: "Correct: $1,800 × 1.12 = $2,016. A 12% buffer covers most common unexpected costs without breaking your budget." },
          { text: "$1,980", correct: false, explanation: "That would be a 10% buffer ($180 extra). A 12% buffer adds $216, giving $2,016." },
        ],
      },
    },
    quiz: [
      ...
      },
      {
        bloom: "Apply",
        bloomColor: "#FEF9C3",
        question: "Your last 3 power bills were $110, $270, and $185. What monthly buffer should you budget?",
        options: [
          "$110 (the lowest)",
          "$185 (the middle)",
          "$270 (the highest)",
        ...
        correct: 3,
        correctExplanation: "Budget based on the average + buffer, not the lowest. Average ($188) + 15% buffer = $216. This protects you in expensive months while not over-allocating in cheap ones.",
        wrongExplanation: "Budget using the average ($188) plus a safety buffer. The lowest would leave you short in expensive months.",
  ...
  // ═══════════════ TIER 3 — FULL SEMESTER ════════════════
  {
    ...
    kolbScenario: {
      ...
      concreteSituation: "It's Week 3. StudyLink payments are delayed by 2 weeks due to a processing issue. Your rent is due in 4 days ($220). You have $110 in your account and get a part-time shift worth $140 on Thursday.",
      predictionPrompt: "How much will you have after the Thursday shift, and will it cover rent?",
      predictionUnit: "$",
      actualOutcome: 250,
      actualExplanation: "$110 + $140 = $250 on Thursday — enough to cover $220 rent, with $30 left for the week. But no buffer for groceries. A cash-flow buffer of even 1 week's income would have prevented this stress entirely.",
      conceptCard: {
      ...
      applyQuestion: {
        prompt: "Your income varies: $380 in even weeks, $220 in odd weeks (average $300). Your weekly fixed costs are $310. What's your best strategy?",
        options: [
          { text: "Budget $380/week — use the good weeks", correct: false, explanation: "Using the higher amount ignores odd weeks where you earn less than your costs. You'd shortfall by $90 on odd weeks." },
          { text: "Budget $220/week and build up — cut costs below $220", correct: false, explanation: "This would require cutting below your fixed costs ($310), which isn't possible. You must earn more than fixed costs." },
    ...
    quiz: [
      ...
      },
      {
        bloom: "Apply",
        bloomColor: "#FEF9C3",
        question: "You earn $760 every fortnight. Monthly rent is $950. Does your income cover rent, and what's the challenge?",
        options: [
          "No — $760 × 2 = $1,520/month, well above $950",
        ...
        correct: 1,
        correctExplanation: "Annually you earn $1,520/month, which covers $950 rent. But if rent is due on the 1st and your second pay doesn't arrive until the 14th, there's a 14-day gap where you need the full $950 in your account. Timing matters.",
        wrongExplanation: "Income covers rent annually, but monthly timing can create a gap between when you need $950 and when you have it.",
        retryExplanation: "You have the money — but do you have it at the RIGHT TIME to pay rent on the 1st?",
      },
      {
        bloom: "Evaluate",
        bloomColor: "#FCE7F3",
        question: "Two students both average $320/week income. Alex has a stable $320/week job. Jordan earns $520 one week, $120 the next. Who has the harder budgeting challenge and why?",
        options: [
        ...
        correct: 1,
        correctExplanation: "Same average, very different challenge. Jordan must actively manage cash flow — saving surplus in $520 weeks to cover the $120 weeks. Without this, they'll have shortfalls every other week despite the same annual income.",
        ...
        retryExplanation: "Imagine paying rent is due on a week where Jordan earns $120. Where does the rest come from?",
      },
    ],
  },

  {
    ...
    kolbScenario: {
      ...
      concreteSituation: "End of tenancy. The landlord deducts $510 from the $1,600 bond for cleaning (the kitchen and bathrooms were not cleaned to standard). One flatmate (Sam) refuses to pay their share, claiming they 'always cleaned their room'.",
      predictionPrompt: "How much do you predict each of 3 flatmates owes for the $510 deduction?",
      predictionUnit: "$",
      actualOutcome: 170,
      actualExplanation: "$510 ÷ 3 = $170 each. Even if Sam 'kept their room clean', common areas (kitchen, bathrooms) are shared responsibility. The flat operates as a unit in tenancy law.",
      conceptCard: {
    ...
    quiz: [
      ...
      },
      {
        bloom: "Apply",
        bloomColor: "#FEF9C3",
        question: "Your bond is $1,400 for 3 flatmates. The landlord deducts $330 for cleaning and $200 for a broken blind (Sam's room). How much does each person get back?",
        options: [
          "$467 each — split equally",
          "Alex: $533, Jordan: $533, Sam: $333 (Sam covers their broken blind)",
          "$290 each after all deductions split equally",
          "Alex and Jordan get $467 each, Sam gets $0"
        ],
        correct: 1,
        correctExplanation: "Cleaning ($330) splits equally: $110 each. The blind ($200) is Sam's responsibility as it's in their room. Alex & Jordan each get: ($1,400/3) − $110 = $357; Sam gets $357 − $200 = $157. Best answer: Alex and Jordan each get $533, Sam gets $333 (with Sam paying their broken blind share).",
        wrongExplanation: "Split the cleaning evenly ($110 each), but Sam alone covers the blind they broke ($200).",
