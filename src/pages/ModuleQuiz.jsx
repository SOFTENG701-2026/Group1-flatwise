    ...
    return (
      <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} className="space-y-5">
        ...
        <div className="bg-[#1B4332] rounded-2xl p-5 text-center">
          ...
          <p className="text-[#D1FAE5] text-xs font-semibold uppercase tracking-wider">Module complete!</p>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm">
          <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-3">What you learned</p>
          ...
          <TooltipTrigger asChild>
            <div className="cursor-help">
              <div className="flex items-center justify-between mb-1">
                <p className="text-xs font-bold text-gray-500 uppercase tracking-wider">Knowledge Check</p>
                <span className="text-xs text-gray-500">{current + 1}/{totalQ}</span>
              </div>
              ...
              <div className="mt-2 flex items-center justify-between">
                <span className="text-xs text-gray-500">Score: {score}/{current * 2 + (isCorrect ? 2 : attempts > 0 ? 1 : 0)}</span>
